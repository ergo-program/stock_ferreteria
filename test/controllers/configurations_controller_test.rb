...
class ConfigurationsControllerTest < ActionController::TestCase
  ...
  test "should create configuration" do
    assert_difference('Configuration.count') do
      post :create, configuration: { direccion: @configuration.direccion, email: @configuration.email, imagen: @configuration.imagen, nombre: @configuration.nombre, telefono: @configuration.telefono, tiempo_espera: @configuration.tiempo_espera }
    end
  ...
  test "should update configuration" do
    patch :update, id: @configuration, configuration: { direccion: @configuration.direccion, email: @configuration.email, imagen: @configuration.imagen, nombre: @configuration.nombre, telefono: @configuration.telefono, tiempo_espera: @configuration.tiempo_espera }
    assert_redirected_to configuration_path(assigns(:configuration))
  end
